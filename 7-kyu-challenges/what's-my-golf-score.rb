#I have the par value for each hole on a golf course and my stroke score on each hole. I have them stored as strings, because I wrote them down on a sheet of paper. 
...
two = 0
  18.times do |i|
    one = one + par_str[i].to_i
    two = two + score_str[i].to_i
  end
two - one
end
